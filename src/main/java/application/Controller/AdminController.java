...
public class AdminController {
    ...
    public String updateEmployee(HttpServletRequest request) {
        Optional<Employee> optionalEmployee = employeeRepository.findById(Long.parseLong(request.getParameter("id")));
        optionalEmployee.ifPresent(existingEmployee -> {
    ...
    public ModelAndView searchEmployee(HttpServletRequest request) throws Exception {
        ...
        List<Log> report = logRepository.findByUserAndTimestampBetween(user.get(),from,to);
